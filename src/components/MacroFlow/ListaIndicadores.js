    ...
    return (
        ...
        >
            ...
            <div className="relative max-w-5xl px-4 py-12 mx-auto z-10">
                <p className="text-2xl font-normal md:text-center md:text-4xl">O <strong>MacroFlow</strong> é mais que um <strong>sistema de análise de fluxo real</strong> - é sua arma secreta no mercado.</p>
