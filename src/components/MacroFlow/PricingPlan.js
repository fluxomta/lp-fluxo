                ...
                <div className=" md:text-lg grid md:grid-cols-3 gap-8 mt-4">
                    ...
                    <div className="bg-white border-2 col-span-2 md:col-span-1 border-secondary-400 rounded-lg shadow-lg md:scale-100 md:hover:scale-105 transition-all">
                        <div className="relative p-6 text-primary-500">
                            ...
                            <div className='flex items-center justify-center'>
                                <p className=" text-center black-gradient p-2 rounded-lg w-full">
                                    <span className="text-7xl font-bold text-secondary-500 tracking-tighter">R$ 329</span>
                                    <span className="text-lg font-base text-secondary-300 block"> /mensal *</span>
                                </p>
                            </div>
                            <div className='block'>
                    ...
                    <div className="bg-white border-2 col-span-2 md:col-span-1 border-secondary-400 rounded-lg shadow-lg md:scale-100 md:hover:scale-105 transition-all">
                        <div className="p-6 text-primary-500">
                            <span className='text-sm inline-block px-4 py-1.5 font-semibold bg-primary-500  text-white rounded-full'>Assine o pacote </span>
                            <p className='text-3xl font-bold md:text-5xl !mt-0.5'>
                                Speedflow <span className='block text-2xl font-bold yellow'>Semestral</span></p>
                            <div className='flex items-center justify-center'>
                                <p className=" text-center black-gradient p-2 rounded-lg w-full">
                                    <span className="text-7xl font-bold text-secondary-500 tracking-tighter">R$ 1.699</span>
