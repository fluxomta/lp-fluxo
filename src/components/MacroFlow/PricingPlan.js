                ...
                <div className=" md:text-lg  grid md:grid-cols-2 gap-8 mt-4">
                    <div className="bg-white border-2 border-secondary-400 rounded-lg shadow-lg md:scale-90 md:hover:scale-95 transition-all">
                        <div className="p-6 text-primary-500">
                            <p className='text-3xl font-bold md:text-5xl'>MacroFlow <span className='block text-2xl font-bold yellow'>O sistema de análise de fluxo real</span></p>
                            <p className='text-md font-base text-gray-700'>Assine o Indicador <strong>MacroFlow</strong> e tenha acesso imediato com suporte exclusivo. E mais: <strong>ganhe o indicador ZD como bônus</strong>, totalmente grátis para seu operacional.</p>
