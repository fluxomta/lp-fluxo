                    ...
                    <div className=" md:text-lg  grid md:grid-cols-2 gap-8 mt-4">
                        <div className="bg-white border-2 border-secondary-400 rounded-lg shadow-lg md:scale-90 md:hover:scale-95 transition-all">
                            <div className="p-6 text-primary-500">
                                ...
                                <ul>
                                    <li className='flex items-center border-b py-2'><Icons.Check className="w-7 mr-1 text-primary-700 rounded-full" />Indicador <strong className='ml-1'>Fluxo V6</strong></li>
                                ...
                                <Link href="https://assine.fluxomta.com/?add-to-cart=87"
