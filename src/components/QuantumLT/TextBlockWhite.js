    ...
    return (
        <section className="text-white black-gradient border-y border-secondary-700">
            <div className="max-w-6xl px-8 py-12 mx-auto text-lg ms:px-4 md:text-center">
                ...
                <p className="mb-2 text-3xl font-semibold md:text-4xl md:text-left yellow">Quantum LT | O Rastreador de Liquidez</p>
                <div className='grid grid-cols-1 gap-4'>
                    ...
                    <div className='flex items-start p-4 mb-2 border rounded-md border-secondary-700 black-gradient'>
                        <div className=''>
                            ...
                            <p className='px-8 text-lg text-left'>
                                Com o Quantum LT, você pode <strong>determinar pontos de entrada, alvos e stops com maior certeza</strong>, você não vai cair mais em armadilhas do mercado.</p>
                        </div>
                    </div>
                </div>
            </div>
