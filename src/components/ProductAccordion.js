...
export default function ImageAccordion() {
    return (
        <div className="px-8 py-16 text-white bg-primary-900">
            ...
            <div className="max-w-6xl mx-auto hidden md:flex w-full h-[400px] overflow-hidden rounded-lg border-2 border-secondary-700"> {/* Contêiner interno centralizado para desktop */}
