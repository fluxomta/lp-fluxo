...
export default function PrincipiosSlider() {
    return (
        <section className="text-white bg-black">
            <div className="max-w-6xl px-8 py-16 mx-auto text-lg text-center">
                <h2 className="mb-4 text-2xl font-bold md:text-4xl ">Metodologia de Camadas <span className="yellow">Estratégicas</span></h2>
