...
export default function BgGlobe() {
    return (
        <section
            className="relative min-h-[90vh] text-white bg-black"
        // style={{
        ...
        >
            <div className="max-w-6xl px-4 py-16 mx-auto md:text-lg ">
                ...
                <div className="grid grid-cols-3 grid-rows-3 gap-4">
                    <div className="col-span-1 row-start-1 col-start-1 px-6 py-4 rounded-md bg-primary-700">
                    ...
                    <div className="col-span-1 row-start-2 col-start-3 px-6 py-4 rounded-md bg-primary-700">
                    ...
                    <div className="col-span-1 row-start-3 col-start-1 px-6 py-4 rounded-md bg-primary-700">
